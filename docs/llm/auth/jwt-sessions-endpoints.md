...
> SSOT | **Last Updated**: 2026-03-28 | Classification: Operational
...
| `infrastructure/inbound/http/openai_completions_handlers.rs` | test completions + stream (JWT, no rate limit) |
