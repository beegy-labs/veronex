//! inferq-agent — lightweight hardware metrics HTTP server.
//!
...
//! ```bash
//! # Docker
//! docker run -d --name inferq-agent \
//!   -p 9091:9091 \
//!   -v /sys:/sys:ro \
//!   -v /proc/meminfo:/proc/meminfo:ro \
//!   -e OLLAMA_URL=http://host.docker.internal:11434 \
//!   ghcr.io/beegy/inferq-agent:latest
//!
//! # Bare-metal
//! ./inferq-agent
//! ```
...
async fn main() {
    ...
    tracing::info!("inferq-agent listening on {addr} (ollama={ollama_url})", ollama_url = cfg.ollama_url);
