...
CREATE TABLE model_capacity (
    ...
    arch_num_layers       INT      NOT NULL DEFAULT 0,
    arch_num_kv_heads     INT      NOT NULL DEFAULT 0,
    arch_head_dim         INT      NOT NULL DEFAULT 0,
    arch_configured_ctx   INT      NOT NULL DEFAULT 0,
    vram_kv_per_slot_mb   INT      NOT NULL DEFAULT 0,
    vram_kv_worst_case_mb INT      NOT NULL DEFAULT 0,
