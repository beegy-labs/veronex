        ...
        sqlx::query(
            "INSERT INTO inference_jobs
             ...
             ON CONFLICT (id) DO UPDATE SET
                 ...
                 mcp_loop_id           = COALESCE(EXCLUDED.mcp_loop_id, inference_jobs.mcp_loop_id)",
        )
        .bind(job.id.0)
