...
impl S3MessageStore {
    ...
    fn key(owner_id: Uuid, _date: NaiveDate, entity_id: Uuid) -> String {
        // No date in path — prevents S3 hot-partition on temporal prefixes.
        // Partition by owner_id for even distribution.
        format!("conversations/{}/{}.json.zst", owner_id, entity_id)
    }
